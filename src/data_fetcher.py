...
class DataFetcher:
    ...
    def fetch_historical_data(self, asset_code: str,
        ...
        Args:
            ...
            start_date: 开始日期 (YYYY-MM-DD)，默认2017-01-01（Binance历史数据限制）
        ...
        if start_date is None:
            # Binance成立于2017年，数据最早从2017年开始
            start_date = "2017-08-01"  # Binance上线时间
        ...
        try:
            ...
            while current_ts < end_ts:
                ...
                current_ts = data[-1][6] + 1  # 使用收盘时间加1毫秒
    ...
    def fetch_incremental_data(self, asset_code: str,
        ...
        print(f"正在获取{asset_code}从{from_date}到{to_date}的USDT数据...")
